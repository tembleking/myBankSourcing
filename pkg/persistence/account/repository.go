...
func (r *Repository) GetByID(ctx context.Context, id string) (*account.Account, error) {
	...
	return account.NewAccount(domainEvents...), err
}

// Save implements domain.Repository.
func (r *Repository) Save(ctx context.Context, aggregate *account.Account) error {
