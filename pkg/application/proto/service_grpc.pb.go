...
func (c *clerkAPIServiceClient) OpenAccount(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*OpenAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClerkAPIService_OpenAccount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clerkAPIServiceClient) ListAccounts(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListAccountsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClerkAPIService_ListAccounts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clerkAPIServiceClient) AddMoney(ctx context.Context, in *AddMoneyRequest, opts ...grpc.CallOption) (*AddMoneyResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClerkAPIService_AddMoney_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clerkAPIServiceClient) WithdrawMoney(ctx context.Context, in *WithdrawMoneyRequest, opts ...grpc.CallOption) (*WithdrawMoneyResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClerkAPIService_WithdrawMoney_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clerkAPIServiceClient) CloseAccount(ctx context.Context, in *CloseAccountRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, ClerkAPIService_CloseAccount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedClerkAPIServiceServer should be embedded to have
...
func (UnimplementedClerkAPIServiceServer) testEmbeddedByValue() {}
...
func RegisterClerkAPIServiceServer(s grpc.ServiceRegistrar, srv ClerkAPIServiceServer) {
	// If the following call pancis, it indicates UnimplementedClerkAPIServiceServer was
